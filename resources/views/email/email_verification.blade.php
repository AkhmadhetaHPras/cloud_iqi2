                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                ...
                                <tr>
                                    <td align="center" class="center-text">
                                        <img style="width:190px;border:0px;display: inline!important;" src="{{ asset('img/emails/Email-2_Intro.png') }}" width="190" border="0" alt="intro">
                                    </td>
                                </tr>
                                <tr>
                                    <td height="40" style="font-size:40px;line-height:40px;">&nbsp;</td>
                                                            ...
                                                            <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="{{ config('pleb.mail.facebook_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('img/emails/Facebook.png') }}" width="36" border="0" alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="{{ config('pleb.mail.instagram_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('img/emails/Instagram.png') }}" width="36" border="0" alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="{{ config('pleb.mail.twitter_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('img/emails/Twitter.png') }}" width="36" border="0" alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="{{ config('pleb.mail.pinterest_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('img/emails/Pinterest.png') }}" width="36" border="0" alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                        <tr>
                                                            <td align="center">
                                                                <a href="{{config('pleb.mail.ios_url')}}"><img style="display:block;width:100%;max-width:117px;border:0px;" width="117" src="{{ asset('img/emails/App-Store.png') }}" border="0" alt="icon"></a>
                                                            </td>
                                                            <td width="10" style="width: 10px;"></td>
                                                            <td align="center">
                                                                <a href="{{config('pleb.mail.play_url')}}"><img style="display:block;width:100%;max-width:117px;border:0px;" width="117" src="{{ asset('img/emails/Google-play.png') }}" border="0" alt="icon"></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- column -->
