                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                ...
                                <tr>
                                    <td align="center" class="center-text">
                                        <img style="width:190px;border:0px;display: inline!important;" src="{{ config('pleb.mail.intro-18') }}" width="190" border="0" alt="intro">
                                    </td>
                                </tr>
                                <tr>
                                    <td height="40" style="font-size:40px;line-height:40px;">&nbsp;</td>
                                ...
                                <tr>
                                    <td class="center-text" align="center" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:26px;line-height:36px;font-weight:400;font-style:normal;color:#d7e057;text-decoration:none;letter-spacing:0px;">
                                        ...
                                        <div>
                                            Kami mengirimkan email sebagai notifikasi
                                        </div>
                                ...
                                <tr>
                                    <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                        ...
                                        <div>
                                            Berikut ini adalah informasi respon yang telah anda masukkan
                                        </div>
                ...
                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                    ...
                    <tr>
                        <td align="center" bgcolor="#FFFFFF">
                            <img style="width:50px;border:0px;display: inline!important;" src="{{ config('pleb.mail.arrow') }}" width="50" border="0" alt="arrow">
                        </td>
                    </tr>
                </table>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="row" width="480" style="width:480px;max-width:480px;">
                                            <tr>
                                                <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:26px;font-weight:400;font-style:italic;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                                    ...
                                                    <div>
                                                        Transfer nominal yang telah anda masukkan pada formulir ke rekening BSM/BSI 711 910 7207 an. INFAQ YAYASAN IHYAUL serta kirimkan bukti transfer kepada <a href="https://wa.me/{{ config('pleb.mail.phone_number') }}" target="_blank" style="color:#ed6e7a;text-decoration: underline;">Admin ({{ config('pleb.mail.phone_number') }})</a>
                                                    </div>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <!-- Paragraphs -->
                                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="row" width="480" style="width:480px;max-width:480px;margin-top:30px">
                                                        <tr>
                                                            <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:26px;font-weight:400;font-style:italic;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">

                                                                <div>
                                                                    (Jika anda memiliki pertanyaan hubungi admin kami <a href="mailto:{{ config('pleb.mail.info_email') }}" style="color:#ed6e7a;text-decoration: underline;">di sini</a>)
                                                                </div>
                                                            ...
                                                            <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="{{ config('pleb.mail.facebook_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ config('pleb.mail.fb') }}" width="36" border="0" alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="{{ config('pleb.mail.instagram_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ config('pleb.mail.ig') }}" width="36" border="0" alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="{{ config('pleb.mail.twitter_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ config('pleb.mail.twitter') }}" width="36" border="0" alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="{{ config('pleb.mail.pinterest_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ config('pleb.mail.pinterest') }}" width="36" border="0" alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                        <tr>
                                                            <td align="center">
                                                                <a href="{{config('pleb.mail.ios_url')}}"><img style="display:block;width:100%;max-width:117px;border:0px;" width="117" src="{{ config('pleb.mail.app-store') }}" border="0" alt="icon"></a>
                                                            </td>
                                                            <td width="10" style="width: 10px;"></td>
                                                            <td align="center">
                                                                <a href="{{config('pleb.mail.play_url')}}"><img style="display:block;width:100%;max-width:117px;border:0px;" width="117" src="{{ config('pleb.mail.g-play') }}" border="0" alt="icon"></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- column -->
